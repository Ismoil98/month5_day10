...
const elCommentsTemplate = document.querySelector(".comments__item-template").content;
...
function renderUsers(users, element) {
  ...
  users.forEach((user) => {
    ...
    usersTemplate.querySelector(".address__street").textContent = user.address.street;
    usersTemplate.querySelector(".address__suite").textContent = user.address.suite;
    usersTemplate.querySelector(".address__city").textContent = user.address.city;
    usersTemplate.querySelector(".address__zipcode").textContent = user.address.zipcode;
    usersTemplate.querySelector(".geo__link").href = "https://www.google.com/maps/place/" + user.address.geo.lat + "," + user.address.geo.lng;
    usersTemplate.querySelector(".user__phone").textContent = user.phone;
    usersTemplate.querySelector(".user__website").href = "https://www." + user.website;
    usersTemplate.querySelector(".company__name").textContent = user.company.name;
    usersTemplate.querySelector(".company__catch-phrase").textContent = user.company.catchPhrase;
